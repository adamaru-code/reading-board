...
ActiveRecord::Schema[8.1].define(version: 2026_09_26_120000) do
  ...
  create_table "hidden_tags", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.string "name", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id", "name"], name: "index_hidden_tags_on_user_id_and_name", unique: true
    t.index ["user_id"], name: "index_hidden_tags_on_user_id"
  end
  ...
  add_foreign_key "hidden_tags", "users"
